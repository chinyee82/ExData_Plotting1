# read power consumption dataset and name variables
power <- read.table("household_power_consumption.txt",skip=1,sep=";")
names(power) <- c("Date","Time","Global_active_power","Global_reactive_power","Voltage","Global_intensity","Sub_metering_1","Sub_metering_2","Sub_metering_3")

# subsetting data corresponding to 1/2/2007 and 2/2/2007
subpower <- subset(power,power$Date=="1/2/2007" | power$Date =="2/2/2007")

# converting Date and Time from characters into objects of type Date and POSIXlt
...
# set par for multiple graphs
par(mfrow=c(2,2))

# use plot function that calls different plot functions to plot the 4 subgraphs
with(subpower,{
